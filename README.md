...
El proyecto nació para resolver una necesidad real: un espacio digital propio de la UES, con contexto académico (carrera, semestre) y sin el ruido de las redes sociales generalistas. En esta ocasión esta presente la versión para Android.
